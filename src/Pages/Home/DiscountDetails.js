...
const DiscountDetails = ({ data }) => {
  ...
  return (
    <>
      <div className="bg-white shadow-lg shadow-orange-200 w-[90%] md:mt-0 mt-3 rounded-md grid grid-cols-1 md:ml-0 ml-5 md:my-8  md:grid-cols-2  justify-evenly px-5 items-center py-8">

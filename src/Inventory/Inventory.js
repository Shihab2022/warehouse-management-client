    ...
    <div className="relative ">
      ...
      <div className="absolute items-center  grid md:grid-cols-2 gap-2 md:gap-10 justify-center  bg-[rgba(0,0,0,.5)] h-screen md:px-24  top-0">
        ...
        <div className="md:ml-10 ">
          <p className="text-2xl text-amber-500 text-center">
          ...
          <div className="flex md:flex-col flex-wrap items-center justify-center">
            <button
              ...
              className="bg-amber-500 px-5 w-1/2  md:mt-8 py-2 text-white rounded-sm"
            >
              Delivered
            </button>
            <button className="bg-amber-500 px-5 md:w-1/2 w-[40%] md:ml-0 ml-3 py-2 text-white rounded-sm">
              {" "}
              All Inventory
            </button>

            {updateQuantity ? (
              <div className="md:w-[70%] w-[85%]  flex bg-[rgba(0,0,0,.5)]  px-8 my-5 rounded-lg relative">
                <input
                  className=" md:px-5 px-3  shadow-xl my-5 py-2  focus:border-0"
                  type="number"
                  name=""
                  id=""
                ></input>
                <button className="bg-amber-700 md:px-5 px-2 my-5 py-2 border-0 text-white ">
                  Add
                </button>
                <span
                  onClick={() => setUpdateQuantity(!updateQuantity)}
                  className="absolute top-1 md:right-2 right-1 text-rose-700 text-xl"
                >
                  <FaRegTimesCircle />
                </span>
              </div>
              ...
              <button
                onClick={() => setUpdateQuantity(!updateQuantity)}
                className="bg-amber-700 px-5 w-1/2 my-5 py-2 text-white rounded-sm"
              >
                Update Quantity
              </button>
            )}
